<div id="sidebar">
    ...
    <ul class="module-list">
        ...
        <li id="menu-usuarios"><a href="/vanilla-inventario/Usuarios/Vistas/index.php"><span class="icon">👥</span> Usuarios</a></li>
        <li id="menu-clientes"><a href="/vanilla-inventario/Clientes/Vistas/index.php"><span class="icon">🏢</span> Clientes</a></li>
