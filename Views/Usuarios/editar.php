...
<div id="content">
    ...
    <form class="form" onsubmit="guardar(event)">
        ...
        <div class="form-row">
            <div class="form-group">
                <label for="contrasenia">Contraseña <small style="color: red">No llene este campo si no quiere editar la contraseña del usuario</small></label>
                <input type="password" id="contrasenia" placeholder="Contraseña" minlength="8">
            </div>
            <div class="form-group">
